...
*/
function getArtistByIndex(artists, ind) {
  return `the artist at index ${artists[ind].id} is ${artists[ind].name}`
}  
getArtistByIndex(artists, 0)

//returning  'The' instead of 'the' causes a fail.
...
*/
function removeArtist(artists, ind) {
